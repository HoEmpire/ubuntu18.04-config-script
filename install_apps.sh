...
sudo dpkg -i -y ~/ubuntu18/electron-ssr-0.2.6.deb

echo "\e[35m Installing Vscode... \e[0m"
sudo dpkg -i -y ~/ubuntu18/code_1.53.2-1613044664_amd64.deb

echo "\e[35m Installing Chrome... \e[0m"
sudo dpkg -i -y ~/ubuntu18/google-chrome-stable_current_amd64.deb

echo "\e[35m Installing Sougou Pinyin... \e[0m"
sudo apt-get install fcitx
sudo dpkg -i -y ~/ubuntu18/sogoupinyin_2.4.0.3469_amd64.deb
sudo apt -f install

echo "\e[35m Installing WPS... \e[0m"
sudo dpkg -i -y ~/ubuntu18/wps-office_11.1.0.10161_amd64.deb
sudo apt -f install
